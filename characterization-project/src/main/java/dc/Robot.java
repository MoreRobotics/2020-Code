...
public class Robot extends TimedRobot {
  ...
  static private double GEARING = 10.47272727;
  ...
  public void robotInit() {
    ...
    WPI_TalonFX rightFollowerID5 = setupWPI_TalonFX(5, Sides.FOLLOWER, false);    
    ...
    PigeonIMU pigeon = new PigeonIMU(new WPI_TalonSRX(53));
    gyroAngleRadians = () -> {
